...
public class OpenPositionsPageConstant {
    ...
    public static final String OPEN_POSITIONS_PAGE_URL = "https://useinsider.com/careers/open-positions/?department=qualityassurance";
    ...
    public static final By FIRST_JOB_HOVER_PATH = By.xpath("(//div[@data-team=\"qualityassurance\"][1])");
    public static final By APPLY_NOW = By.xpath("//a[text()=\"View Role\"][1]");
    ...
    public static final String OPEN_POSITIONS_PAGE_TITLE_TEXT = "Insider Open Positions | Insider";
