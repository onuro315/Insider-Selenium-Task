...
public class CareersPageConstant {
    ...
    public static final By LIFE_AT_INSIDER_TITLE_PATH = By.xpath("(//div[@class=\"elementor-widget-container\"]/h2[text()='Life at Insider'])");
    public static final By LIFE_AT_INSIDER_TEXT_PATH = By.xpath("(//div[@data-id=\"fe38935\"])");
    ...
    public static final By QA_CAREER = By.linkText("Quality Assurance");
